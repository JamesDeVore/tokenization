...
SubmitButton = Button(window, text="Create Token!",height=5,width=15,font=('Courier',12),command=createToken,bg='lightgrey')
SubmitButton.grid(row=3,column=2,columnspan=3, sticky='N')
